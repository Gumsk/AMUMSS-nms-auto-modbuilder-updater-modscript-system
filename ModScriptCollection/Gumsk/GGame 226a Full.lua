...
TorchRotation = 0						--???
TorchColourRed = 0.0					--Torch color red saturation percent. Original value "0.95"
TorchColourGreen = 1					--Torch color green saturation percent. Original value "0.993"
TorchColourBlue = 0.15					--Torch color blue saturation percent. Original value "0.944"
TorchColourA = 1						--???? Original value "1"

--Scanner Adjustments
TerrainScanTime = 30						--???. Original value "30"
...
AirLockDoorRange = 4					--??? Original value "3"
...
{
["MOD_FILENAME"]	= "GGame 226a Full.pak",
