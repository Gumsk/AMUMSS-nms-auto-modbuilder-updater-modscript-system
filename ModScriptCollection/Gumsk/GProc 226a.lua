...
Element_Bonus_Array = { --(Name [1]Part 1,[2]Name Array Column,[3]Part 3),[4]Min Array,[5]Max Array,[6]Starting Rarity,[7]Always?
	...
	{"Suit_Protection_",3,"Drain",{1.1,1.25,1.45},{1.2,1.35,1.55},3,"True"},
	{"Suit_DamageReduce_",2,"",{0.98,0.91,0.82},{0.93,0.86,0.77},3,"True"}
	}
...
Water_Bonus_Array = { --(Name [1]Part 1,[2]Part 2 Array Column,[3]Part 3),[4]Min Array,[5]Max Array,[6]Starting Rarity,[7]Always? 
	...
	{"Suit_Protection_WaterDrain","","",{1.2,1.4,1.6},{1.4,1.6,1.8},1,"True"},
...
{
["MOD_FILENAME"]	= "GProc 226a Full.pak",
["MOD_DESCRIPTION"]	= "All my changes to the Procedural Technology Table",
["MOD_AUTHOR"]		= "Gumsk",
["NMS_VERSION"]		= "2.26",
["MODIFICATIONS"]	=
{{
...
--=========================================
	for j = 1,#Water_Bonus_Array[1][5] do
		...
		<Property name="Subtitle" value="UPGRADE_SUB_]]..((4-#Water_Bonus_Array[1][5])+j)..[[" />
		<Property name="Description" value="UP_]]..temp_name..((4-#Water_Bonus_Array[1][5])+j)..[[_DESC" />
		<Property name="Colour" value="Colour.xml">
			<Property name="R" value="0.129411772" />
			<Property name="G" value="0.466666669" />
			<Property name="B" value="0.784313738" />
...
--=========================================
	for j = 1,#Mining_Bonus_Array[1][5] do
		...
		<Property name="Template" value="T_]]..temp_name..[[" />
		<Property name="Group" value="UI_]]..Mining_Name_Array[i][1]..[[_NAME_CORE_L" />
		<Property name="Name" value="UP_]]..temp_name..[[" />
		<Property name="NameLower" value="UI_]]..Mining_Name_Array[i][1]..[[_NAME_CORE_L" />
