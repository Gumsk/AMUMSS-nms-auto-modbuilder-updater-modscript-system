...
--Outposts
		...
		OutpostLandingPlanetMinSpeed = 30					--30 ; 
		OutpostLandingPlanetMaxSpeed = 80					--80 ; 
	...
	OutpostDockMaxApproachSpeed = 400						--400 ; 
	OutpostDockOverspeedBrake = 80							--80 ; 
...
{
["MOD_FILENAME"]	= "GFlight NPC 226b.pak",
["MOD_DESCRIPTION"]	= "NPC Flight",
["MOD_AUTHOR"]		= "Gumsk",
["NMS_VERSION"]		= "2.26",
["MODIFICATIONS"]	=
{{
...
{{
	...
	["VALUE_CHANGE_TABLE"] =
	{
		...
		-- {"TradeRouteSeekOutpostRange", 999999},
		-- {"TradeRouteMaxNum", 30},
		-- {"TraderAtTime", 10},
		-- {"TraderAtTimeBack", 15},
		-- {"TraderPerpTime", 7},
